...
cp /usr/local/tomcat/users.xml /usr/local/geoserver-cobweb/data/security/usergroup/default/users.xml && \
sed -i -e \
...
/usr/local/geoserver-cobweb/data/security/usergroup/default/config.xml && \
